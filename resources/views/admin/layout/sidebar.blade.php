...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @endif
            @if (Auth::user()->hasRole('Organizer'))
                <li class="{{ request()->is('ticket-scanner*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('ticket-scanner') }}">
                        <i class="fas fa-qrcode"></i> <span>{{ __('Ticket Scanner') }}</span>
                    </a>
                </li>
            @endif
            @if (Auth::user()->hasRole('Organizer'))
            ...
            <li class="menu-header mt-4">{{ __('Account') }}</li>
            <li>
