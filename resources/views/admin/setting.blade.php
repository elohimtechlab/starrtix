            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4>{{ __('Maintenance & Frontend Control') }}</h4>
                            <p>{{ __('Control site maintenance and frontend access. Full maintenance blocks everyone, Frontend toggle blocks only regular users while keeping admin access.') }}</p>
                            ...
                            <div class="collapse mt-3 " id="maintenace-setting">
                                <form method="post" action="{{ url('maintenance-setting') }} "
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            <hr>
                                            <h6 class="text-primary"><i class="fas fa-toggle-on mr-2"></i>{{ __('Frontend Control') }}</h6>
                                            <small class="text-muted">{{ __('Control frontend access independently (Admin access remains available)') }}</small>
                                        </div>
                                    </div>
                                    
                                    <div class="row mt-3">
                                        <div class="col-md-8">
                                            <span>{{ __('Frontend Status') }}</span>
                                            <br>
                                            <small class="text-muted">
                                                {{ $setting->frontend_maintenance ? __('Frontend is currently DISABLED') : __('Frontend is currently ENABLED') }}
                                            </small>
                                        </div>
                                        <div class="custom-switches-stacked col-md-4 mt-2">
                                            <label class="custom-switch pl-0">
                                                <input type="checkbox" name="frontend_maintenance" 
                                                    class="custom-switch-input" {{ $setting->frontend_maintenance ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">{{ __('Disable Frontend') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="alert alert-info">
                                                ...
                                                <strong>{{ __('Note:') }}</strong> {{ __('Frontend toggle only affects regular users. Admin users can always access the admin panel.') }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form method="post" action="{{ url('frontend-toggle') }}" class="mt-3">
                                    @csrf
                                    <input type="hidden" name="frontend_maintenance" value="{{ $setting->frontend_maintenance ? '1' : '0' }}" id="frontend_maintenance_hidden">
                                    <div class="form-group row mb-4 ml-4">
                                        <div class="col-sm-12 text-center">
                                            <button type="button" class="btn {{ $setting->frontend_maintenance ? 'btn-success' : 'btn-warning' }}" onclick="toggleFrontend()">
                                                <i class="fas {{ $setting->frontend_maintenance ? 'fa-toggle-on' : 'fa-toggle-off' }} mr-1"></i>
                                                {{ $setting->frontend_maintenance ? __('Enable Frontend') : __('Disable Frontend') }}
                                            </button>
                                        </div>
                                    </div>
