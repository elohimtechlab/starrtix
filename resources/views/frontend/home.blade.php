                            ...
                            <a href="{{ url('event/' . $item->event->id . '/' . Str::slug($item->event->name)) }}">
                                <div class="h-1/2 relative">
                                    ...
                                    <div class="absolute inset-0 flex flex-col items-center justify-center pt-[20%]">
                                        <h1
                                            class="font-poppins font-medium leading-6 text-center text-5xl text-white drop-shadow-[1px_1px_1px_rgba(0,0,0,0.5)]">
                                            {{ $item->title }}
                                        </h1>
                                        <div class="mt-8 flex space-x-4">
                                            <a href="{{ route('user.login') }}"
                                                class="px-5 py-2 text-white bg-primary text-center font-poppins font-normal text-base leading-6 rounded-md shadow-lg hover:bg-primary-dark transition duration-300">
                                                {{ __('Create Event') }}
                                            </a>
                                            <a href="{{ url('all-events') }}"
                                                class="px-5 py-2 text-white bg-secondary text-center font-poppins font-normal text-base leading-6 rounded-md shadow-lg hover:bg-secondary-dark transition duration-300">
                                                {{ __('Find Event') }}
                                            </a>
                                        </div>
                                    </div>
