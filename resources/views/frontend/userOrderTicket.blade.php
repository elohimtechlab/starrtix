            ...
            <div
                ...
                <div class="xlg:w-1/3 xmd:w-full xxsm:w-full lg:w-full xxmd:pb-10 xxsm:pb-10">
                    <div class="p-4 bg-white shadow-lg rounded-md space-y-5">
                        ...
                        <div class="flex justify-between xxsm:flex-wrap sm:flex-nowrap space-x-3">
                            <a href="{{ url('order-invoice-print/' . $order->id) }}" target="_blank"
                                class="font-poppins font-normal text-sm leading-5 text-success rounded-md px-4 py-2 bg-success-light flex items-center"><img
                                    src="{{ asset('image/printer.png') }}" alt="" class="mr-2 w-4 h-4">{{ __('Print') }}</a>
                            <a href="{{ route('downloadTicket', $order->id) }}"
                                class="font-poppins font-normal text-sm leading-5 text-blue-600 rounded-md px-4 py-2 bg-blue-100 flex items-center hover:bg-blue-200 transition-colors">
