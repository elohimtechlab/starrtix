...
<body>
    ...
    <div id="app">
        ...
        @php $primary_color = \App\Models\Setting::find(1)->primary_color; @endphp

        <style>
            :root {
                --primary_color: {{ $primary_color }};
                --light_primary_color: {{ $primary_color . '1a' }};
                --profile_primary_color: {{ $primary_color . '52' }};
                --middle_light_primary_color: {{ $primary_color . '85' }};
                /* Custom color scheme */
        ...
        <script src="{{ url('frontend/js/main.js') }}?v={{ time() }}"></script>
        <script src="{{ url('frontend/js/custom.js') }}?v={{ time() }}"></script>
        <script src="{{ url('js/custom.js') }}?v={{ time() }}"></script>
