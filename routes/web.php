...
Route::get('/login', function () {
    if (Auth::check()) {
        ...
        return redirect('/admin/home'); // fallback
    }
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/frontend-toggle', [SettingController::class, 'toggleFrontend']);
    ...
    Route::get('/ticket-scanner', [UserController::class, 'ticketScanner']);
    Route::post('/scan-ticket', [UserController::class, 'scanTicketWeb']);
